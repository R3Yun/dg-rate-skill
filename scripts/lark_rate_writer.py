...
class LarkRateWriter:
    ...
    def _preprocess_entries(self, entries: List[Any],
        ...
        for i, e in enumerate(entries):
            ...
            # D96-fix (2026-09-19): ROL/ROD 推导必须放在 port code 归一之后.
            # 若在归一前跑, port_to_region 会拿到英文港名 (SYDNEY) 并按其前 2 字符
            # 猜国家 (SY=叙利亚→中东), 把错误区域写进飞书库.
            # 仅在原本空时补, 已有值不覆盖; _normalize_select_values 确保候选在 schema 内.
            try:
